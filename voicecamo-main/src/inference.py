...
def evaluate(cfg: DictConfig):
    ...
    path = "/home/pulkit/Downloads/CS753/hacker/voicecamo-main/data/libri_demo_clean_manifest.json"
    test_loader = data_loader.my_dataloader(path)
    list_of_lev_dist=[]
                    ...
                    with torch.no_grad():
                        ...
                        for k in range(inputs.shape[0]):
                            ...
                            if inputs.shape[3] > 255:
                                ...
                                print("--------------------------------------------")
                                print("Original : " + decoded_target)
                                print("Attacked : " + decoded_output[k][0])
                                print("Clean :  " +  decoded_output_clean[k][0])
                                print("--------------------------------------------")
                                # print(decoded_output_clean[k][0])
                                # print(decoded_output_random[k][0])
